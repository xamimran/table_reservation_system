    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          ...
          <button
            onClick={() => router.push('/')}
            className="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out"
          >
            Return to Homepage
          </button>
        </div>
      ...
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-md w-full m-4">
        ...
        {sessionData && (
          <div className="space-y-3 mb-6">
            ...
            <p className="text-gray-700"><span className="font-semibold">Amount Total:</span> {sessionData.amount_total / 100} {sessionData.currency.toUpperCase()}</p>
            <p className="text-gray-700 break-words">
