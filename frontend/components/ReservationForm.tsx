...
export default function ReservationForm() {
  ...
  const handleCardSaved = async (
    ...
    try {
      ...
      // Handle the response based on the card save status
      if (data.applicationStatus === "PA") {
        console.log("Card saved successfully");
        // You can add any additional client-side logic here for successful card save
      } else if (data.applicationStatus === "F") {
