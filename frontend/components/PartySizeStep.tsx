...
export default function PartySizeStep({ adults, setAdults, children, setChildren }: PartySizeStepProps) {
  const maxChildren = parseInt(adults) - 1; 
  const childrenOptions = Array.from({ length: maxChildren >= 0 ? maxChildren + 1 : 1 }, (_, i) => i); 
    ...
    <div className="space-y-6  h-[400px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <Label htmlFor="adults" className="text-lg font-medium flex items-center space-x-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="children" className="text-lg font-medium flex items-center space-x-2">
