"""
Django settings for table_reservation_system project.
...
SECRET_KEY = 'django-insecure-tx2v!^f_62utu(jw24unx2ruhom=#gg--k*v-%uzwwid1+*3an'
...
WSGI_APPLICATION = 'table_reservation_system.wsgi.application'
